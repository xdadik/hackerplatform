...
export const labs: Lab[] = [
  ...
  { id: "lab-4", title: "Cloud IAM Misconfiguration", category: "Cloud Security", difficulty: "Intermediate", duration: "60 min", status: "not_started", description: "Audit AWS IAM policies and exploit overly permissive roles to access sensitive data.", objectives: 6, participants: 3421 },
